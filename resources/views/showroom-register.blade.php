    ...
    <div class="container">
        <div class="row  justify-content-center">
            ...
            <div class="col-lg-12">
                ...
                @endif
                <form action="{{route('showroomCreate')}}" method="POST">
                    @csrf
                    <div class="input_login">
                        <i class="bi bi-house"></i>
                        <input type="text" placeholder=" اسم المعرض " class="form-control" name="user_name">
                    </div>
                    <div class="input_login">
                    ...
                    <a href="" id="show-map">
                        <div class="input_login">
                            ...
                            <input type="tel" placeholder=" العنوان " class="form-control"  name="location">
                        </div>
                    </a>                       
                    <div class="input_login">
                        <i class="bi bi-phone"></i>
                        <input type="tel" placeholder="رقم السجل التجاري" class="form-control"  name="commertial_reg_no">
                    </div>
                    {{-- <div class="uploud_img">
                        <input type="file" id="uploud1" name="commertial_reg_img" >
                        <label for="uploud1" >
                            <div class="sub_uploud_img">
                    ...
                    <div class="input_login ">
                        ...
                        <input type="text"  id="datepicker" value="" class="calendar form-control" placeholder="تاريخ انتهاء السجل التجاري" class="form-control" name="commertial_reg_exp">
                    </div>           
                    <div class="input_login">
                    ...
                    <div class="check_agrea">
                        <input type="checkbox" id="cleck1"  name="">
...
<!--  end terms_modal -->
<!--start model_map-->
<div class="modal fade model_map" id="maps_model">
    <div class="modal-dialog modal-dialog-centered big-modal">
        <div class="modal-content">
            <div class="modal-body">
               <div class="sub_model_map">
                    <div id="map"></div>
                    <input type="text" name="address" class="form-control" placeholder=" موقع المعرض" id="address" required>
